...
<head>
	...
	<link rel="stylesheet" href="{{asset('joeblog.css')}}">
</head>
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <nav class="navbar navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="../../../../joeblog/public_html/assets/imgs/logo.svg" alt="">
            </a>
            <div class="socials">
    ...
    <nav class="navbar custom-navbar navbar-expand-md navbar-light bg-primary sticky-top">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="index1.blade.php">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="no-sidebar.html">No Sidebar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="single-post.blade.php">Single Post</a>
                    </li>
                ...
                <div class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a href="components.blade.php" class="ml-4 btn btn-dark mt-1 btn-sm">Components</a>
                    </li>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <section>
            <div class="feature-posts">
                <a href="single-post.blade.php" class="feature-post-item">
                    <span>Featured Posts</span>
                </a>
                <a href="single-post.blade.php" class="feature-post-item">
                    <img src="../../../../joeblog/public_html/assets/imgs/img-1.jpg" class="w-100" alt="">
                    <div class="feature-post-caption">Incidunt Quaerat</div>
                </a>
                <a href="single-post.blade.php" class="feature-post-item">
                    <img src="../../../../joeblog/public_html/assets/imgs/img-2.jpg" class="w-100" alt="">
                    <div class="feature-post-caption">Culpa Ducimus</div>
                </a>
                <a href="single-post.blade.php" class="feature-post-item">
                    <img src="../../../../joeblog/public_html/assets/imgs/img-3.jpg" class="w-100" alt="">
                    <div class="feature-post-caption">Temporibus Simile</div>
                </a>
                <a href="single-post.blade.php" class="feature-post-item">
                    <img src="../../../../joeblog/public_html/assets/imgs/img-4.jpg" class="w-100" alt="">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="blog-media">
                            <img src="../../../../joeblog/public_html/assets/imgs/blog-6.jpg" alt="" class="w-100">
                    ...
                    <div class="card-footer d-flex justify-content-between align-items-center flex-basis-0">
                        ...
                        <a href="single-post.blade.php" class="btn btn-outline-dark btn-sm">READ MORE</a>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card text-center mb-5">
                            <div class="card-header p-0">
                                <div class="blog-media">
                                    <img src="../../../../joeblog/public_html/assets/imgs/blog-2.jpg" alt="" class="w-100">
                    ...
                    <div class="col-lg-6">
                        <div class="card text-center mb-5">
                            <div class="card-header p-0">
                                <div class="blog-media">
                                    <img src="../../../../joeblog/public_html/assets/imgs/blog-3.jpg" alt="" class="w-100">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card text-center mb-5">
                            <div class="card-header p-0">
                                <div class="blog-media">
                                    <img src="../../../../joeblog/public_html/assets/imgs/blog-4.jpg" alt="" class="w-100">
                    ...
                    <div class="col-lg-6">
                        <div class="card text-center mb-5">
                            <div class="card-header p-0">
                                <div class="blog-media">
                                    <img src="../../../../joeblog/public_html/assets/imgs/blog-5.jpg" alt="" class="w-100">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card text-center mb-5">
                            <div class="card-header p-0">
                                <div class="blog-media">
                                    <img src="../../../../joeblog/public_html/assets/imgs/blog-1.jpg" alt="" class="w-100">
                    ...
                    <div class="col-lg-6">
                        <div class="card text-center mb-5">
                            <div class="card-header p-0">
                                <div class="blog-media">
                                    <img src="../../../../joeblog/public_html/assets/imgs/blog-7.jpg" alt="" class="w-100">
    ...
    <div class="instagram-wrapper mt-5">
        ...
        <a href="javascript:void(0)" class="insta-item">
            <img src="../../../../joeblog/public_html/assets/imgs/insta-1.jpg" alt="" class="w-100">
            <div class="overlay">
                <span>
        ...
        <a href="javascript:void(0)" class="insta-item">
            <img src="../../../../joeblog/public_html/assets/imgs/insta-2.jpg" alt="" class="w-100">
            <div class="overlay">
                <span>
                    <i class="ti-heart"></i> 23
                </span>
        ...
        <a href="javascript:void(0)" class="insta-item">
            <img src="../../../../joeblog/public_html/assets/imgs/insta-3.jpg" alt="" class="w-100">
            <div class="overlay">
                <span>
                    <i class="ti-heart"></i> 23
                </span>
        ...
        <a href="javascript:void(0)" class="insta-item">
            <img src="../../../../joeblog/public_html/assets/imgs/insta-4.jpg" alt="" class="w-100">
            <div class="overlay">
                <span>
                    <i class="ti-heart"></i> 23
                </span>
        ...
        <a href="javascript:void(0)" class="insta-item">
            <img src="../../../../joeblog/public_html/assets/imgs/insta-5.jpg" alt="" class="w-100">
            <div class="overlay">
                <span>
                    <i class="ti-heart"></i> 23
                </span>
        ...
        <a href="javascript:void(0)" class="insta-item">
            <img src="../../../../joeblog/public_html/assets/imgs/insta-6.jpg" alt="" class="w-100">
            <div class="overlay">
                <span>
                    <i class="ti-heart"></i> 23
                </span>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-md-3 text-center text-md-left mb-3 mb-md-0">
                    <img src="../../../../joeblog/public_html/assets/imgs/logo.svg" alt="" class="logo">
                </div>
    ...
    <!-- JoeBLog js -->
    <script src="{{asset('joeblog.js')}}"></script>
