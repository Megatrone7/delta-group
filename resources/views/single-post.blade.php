...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="no-sidebar.blade.php">No Sidebar</a>
                    </li>
                    <li class="nav-item">
    ...
    <header class="page-header page-header-mini">
        ...
        <ol class="breadcrumb pb-0">
            <li class="breadcrumb-item"><a href="index1.blade.php">Home</a></li>
            ...
            <div class="page-content">
                <div class="card">
                    ...
                    <div class="card-footer">
                        ...
                        <hr>
                        <div class="media">
                            <img src="../../../../joeblog/public_html/assets/imgs/avatar-1.jpg" class="mr-3 thumb-sm rounded-circle" alt="...">
                            <div class="media-body">
                                ...
                                <div class="media mt-5">
                                    <a class="mr-3" href="#">
                                    <img src="../../../../joeblog/public_html/assets/imgs/avatar.jpg" class="thumb-sm rounded-circle" alt="...">
                                    </a>
                        ...
                        <div class="media mt-5">
                            <img src="../../../../joeblog/public_html/assets/imgs/avatar-2.jpg" class="mr-3 thumb-sm rounded-circle" alt="...">
                            <div class="media-body">
                        ...
                        <div class="media mt-4">
                            <img src="../../../../joeblog/public_html/assets/imgs/avatar-3.jpg" class="mr-3 thumb-sm rounded-circle" alt="...">
                            <div class="media-body">
    ...
    <!-- JoeBLog js -->
    <script src="../../../../joeblog/public_html/assets/js/joeblog.js"></script>
